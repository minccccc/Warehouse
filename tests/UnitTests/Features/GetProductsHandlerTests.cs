...
namespace UnitTests.Features
{
    public class GetProductsHandlerTests
    {
        ...
        public async Task Should_ReturnAllProducts()
        {
            ...
            result.Should().BeOfType<GetProductsResponse>();
        }
        ...
        private async Task<GetProductsResponse> SendToHandler(GetProductsQuery query)
        {
            var cacheProviderMock = ICacheProviderMock.GetMock();

            var handler = new GetProductsHandler(cacheProviderMock.Object);
